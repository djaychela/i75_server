...
def build_ha_api_namedtuple(current_settings_dict):
    HaValues = namedtuple("HaValues", ["description", "name", "value"])
    settings_to_extract = {
    ...
    api_base_values = [HaValues(key, value, current_settings_dict[value]) for key, value in settings_to_extract.items()]
